...
import { MultiSelectWithDisableProps } from './type';
import styled from '@emotion/styled';
import Select from 'react-dropdown-select';
import styles from './multi-select-with-disable.module.scss';

export const MultiSelectWithDisable: React.FC<MultiSelectWithDisableProps> = ({
	name,
	caption,
	options,
	values,
	...
	// Стандартный вид опции, вид опции в отключенном состоянии
	const itemRenderer = ({ item, methods, state }) => {
